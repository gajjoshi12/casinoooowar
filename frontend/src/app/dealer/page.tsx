                    ...
                    playerId => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`bg-red-400/5 border-2 border-dashed border-white p-4 rounded-lg ${isActive ? '' : 'opacity-30'
                            }`}
                        >
                          <div className='flex justify-between items-center mb-3'>
                        ...
                        /> */}
                          ...
                          {isActive && playerData.result && (
                            ...
                            transform transition-all duration-200 shadow ${playerData.result === 'win'
